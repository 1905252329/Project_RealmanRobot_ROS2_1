...
/**************************************************************end*************************************************************************/
    ...
    rclcpp::Service<rm_ros_interfaces::srv::ModbusControl>::SharedPtr modbus_control_service_;
    rclcpp::Service<rm_ros_interfaces::srv::GetDH>::SharedPtr get_dh_service_;
    ...
    std::string arm_ip_ = "169.254.247.18";    
    std::string udp_ip_ = "169.254.247.10";
...
private:
    ...
    // 添加缺失的发布器
    rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr udp_real_joint_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Jointerrorcode>::SharedPtr udp_joint_error_code_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Jointcurrent>::SharedPtr udp_joint_current_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Jointenflag>::SharedPtr udp_joint_en_flag_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Jointspeed>::SharedPtr udp_joint_speed_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Jointtemperature>::SharedPtr udp_joint_temperature_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Jointvoltage>::SharedPtr udp_joint_voltage_pub_;
    rclcpp::Publisher<rm_ros_interfaces::msg::Rmerr>::SharedPtr udp_rm_err_pub_;
