...
LastEditTime: 2025-09-27 21:09:50
Description: 
FilePath: /ros2_rm_ws/src/ros2_rm_robot-humble/rm_motion_planner/launch/rm_sclerp_planner_node_leftArm.launch.py
'''
...
def generate_launch_description():
    ...
    with open(params_file, 'r') as f:
        params = yaml.safe_load(f)['rm_sclerp_planner_node_leftArm']['ros__parameters']
