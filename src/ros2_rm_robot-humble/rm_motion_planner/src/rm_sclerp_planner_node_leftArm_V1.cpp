 ...
 * @note 功能测试版本V1, 支持定时器或动作两种设计模式切换   
...
// #region 动作回调函数
    ...
    {
        RCLCPP_INFO(this->get_logger(), "Received grasp box goal: %s", goal->target.c_str());
        (void)uuid;
        // 可以在这里添加目标验证逻辑
 ...
 */
     ...
     */
    void saveJointTrajectoryPositionsToFile(const trajectory_msgs::msg::JointTrajectory& joint_trajectory, 
